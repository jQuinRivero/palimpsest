...
async function startApi() {
  ...
  const child = spawnLogged(
    "uv",
    ["--directory", "backend", "run", "uvicorn", "app.main:app", "--host", "127.0.0.1", "--port", apiPort],
    { name: "api", shell: process.platform === "win32" },
  );
...
async function startWeb() {
  ...
  const child = spawnLogged("npm", ["--prefix", "frontend", "run", "dev", "--", "--hostname", "127.0.0.1", "--port", webPort], {
    name: "web",
